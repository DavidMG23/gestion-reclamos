...
<body>
    ...
    if (empty($xreclamo)||!empty($xreclamo)||empty($xestado)||!empty($xestado)) {
        $ver = "SELECT * FROM bd_chimbas WHERE reclamo = '$xreclamo' OR estado = '$xestado' "; //si queremos usar los sellect combinados cambir el OR por AND
    ...
    ?>
        ...
        <tr> 
            <td>
                <?php
                $filtro = "SELECT COUNT(*) total FROM bd_chimbas";
            ...
            <td>
                <?php    
                $filtro = "SELECT COUNT(*) total FROM bd_chimbas WHERE estado = 'Pendiente' ";
                $result = mysqli_query($conexion,$filtro);
                $contador = mysqli_fetch_assoc($result);
                echo $contador['total'];
                ?>
            ...
            <td>
                <?php    
                $filtro = "SELECT COUNT(*) total FROM bd_chimbas WHERE estado = 'En proceso' ";
                $result = mysqli_query($conexion,$filtro);
                $contador = mysqli_fetch_assoc($result);
                echo $contador['total'];
                ?>
            ...
            <td>
                <?php    
                $filtro = "SELECT COUNT(*) total FROM bd_chimbas WHERE estado = 'Finalizado' ";
                $result = mysqli_query($conexion,$filtro);
                $contador = mysqli_fetch_assoc($result);
                echo $contador['total'];
                ?>
