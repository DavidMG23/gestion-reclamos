            ...
            <div class="col-12">
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST" class="formReg" name="login">
                    ...
                    <div class="form-grup">
                        ...
                        <input type="text" name="usuario" class="usuario" placeholder="Usuario/Departamento">
                    </div>
                    <div class="form-grup">
                    ...
                    <button type="submit" class="btn btn-success"><i class="fas fa-address-card"></i> Acreditar</button>
                    </div>
                ...
                <a href="login.php" class="registrate">Inicia Sesión</a>
                <br>
